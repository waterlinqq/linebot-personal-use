...
class BotService:
    def __init__(self, config: MatchConfig, connector: LineConnector | None = None) -> None:
    ...
    def _handle_message(self, message: IncomingMessage) -> None:
        with self._lock:
            ...
            insert_message_log(
                ...
                reason=match.reason if match.should_reply else parsed.reason or match.reason,
            )
